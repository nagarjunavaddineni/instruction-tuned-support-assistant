...
def main():
    ...
    def enc(r):
        x = tok(r["input"], truncation=True, max_length=256, padding="max_length")
    ...
    model.save_pretrained("outputs/classifier-tensorflow")
    tok.save_pretrained("outputs/classifier-tensorflow")
